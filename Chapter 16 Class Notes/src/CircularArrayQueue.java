...
public class CircularArrayQueue
{
    ...
    */
    public CircularArrayQueue()
    {
        ...
        head = 0;
        tail = 0;
        currentSize = 0; // the queue is empty when first created.
    }
    ...
    */
    public void add(Object element)
    {
        ...
        // rerset the tail to 0 when it reaches the size of the array
    ...
    */
    public Object remove()
    {
        ...
        // resets the head to 0 if we reach the array end
